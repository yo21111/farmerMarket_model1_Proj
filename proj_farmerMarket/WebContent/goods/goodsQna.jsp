	...
	<div id="goodsQna">
		<div class="dimmed">
			<div class="popup">
				...
				<div class="content">
					<form id="goodsQnaFrm" enctype="multipart/form-data" method="post"
						action="/goods/updateQnaBBSProc.jsp?goodsCode=<%=goodsCode%>">
						<table>
							<tr>
								<td>&nbsp;</td>
								<td id="info">
							...
							<tr>
								<td id="tdBtn" colspan="2"><button id="cancelBtn"
